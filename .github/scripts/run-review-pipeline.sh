...
- In the FINAL JSON output, merge:
  a. Carried-forward violations (include as-is in inline_comments and violation list)
...
- In stats, include these additional fields:
  carried_forward: <count>, revalidated: <count>, new_findings: <count>
